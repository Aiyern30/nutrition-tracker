    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 backdrop-blur-md bg-background/80 border-b border-border/50">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="hidden sm:flex items-center gap-2 rounded-full px-5 bg-primary hover:bg-primary/90 shadow-md shadow-primary/30 transition-all"
          >
      ...
      <section className="relative pt-32 pb-20 px-6 flex flex-col items-center text-center overflow-hidden">
        ...
        <h1 className="relative text-5xl sm:text-6xl md:text-7xl font-extrabold tracking-tight leading-tight max-w-4xl">
          Eat Smarter,{" "}
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-violet-500 to-emerald-500">
            Live Better
          </span>
        </h1>
        ...
        {/* CTA Login Card */}
        <div className="relative mt-12 w-full max-w-sm bg-card/80 backdrop-blur-md border border-border/60 rounded-2xl p-6 shadow-xl shadow-black/10">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Button
              ...
              disabled={loading !== null}
              variant="outline"
              className="w-full h-11 rounded-xl group border-border/60 hover:border-primary/50 hover:bg-primary/5 transition-all"
            >
              {loading === "google" ? (
          ...
          <p className="mt-4 text-xs text-muted-foreground text-center leading-relaxed">
            By signing in, you agree to our Terms of Service. This app does not
            store any passwords.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
          {[
            ...
            <div key={stat.label} className="flex flex-col items-center gap-1">
              <span className="text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-primary to-violet-500">
                {stat.value}
              </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((feat) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-11 h-11 rounded-xl bg-gradient-to-br ${feat.color} flex items-center justify-center mb-4 shadow-md`}
                  >
      ...
      <section className="px-6 pb-16">
        <div className="max-w-6xl mx-auto">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-500/20 via-blue-500/10 to-background border border-sky-500/20 p-8 sm:p-12 flex flex-col sm:flex-row items-center gap-8">
            <div
            ...
            />
            <div className="flex-shrink-0 w-16 h-16 rounded-2xl bg-sky-500/20 border border-sky-500/30 flex items-center justify-center">
